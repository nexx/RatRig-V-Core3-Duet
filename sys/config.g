...
M906 X1800 Y1800 Z1500 E700 I50										; Set motor currents (mA) and motor idle factor in per cent
...
M307 H0 R0.860 C439.9 D11.80 S1.00 V24.1 B0							; PID Tuning for Heater0, Heated Bed (45C)
...
M106 P0 S0 H-1 C"Part Cooling"										; Set Fan0 to default off, manual control
